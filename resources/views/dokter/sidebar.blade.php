...
<body>
    <div class="sidebar">
        ...
        <h3>Dokter</h3>
        <a href="{{ route('dokter.dashboard') }}" class="btn {{ Request::routeIs('dokter.dashboard') ? 'active' : '' }}">
            <i class="bi bi-house-door"></i> Dashboard
        </a>
        <a href="{{ route('dokter.daftarantrian') }}" class="btn {{ Request::routeIs('dokter.daftarantrian') ? 'active' : '' }}">
            <i class="bi bi-card-list"></i> Daftar Antrian
        </a>
        <a href="{{ route('dokter.rekammedis') }}" class="btn {{ Request::routeIs('dokter.rekammedis') ? 'active' : '' }}">
