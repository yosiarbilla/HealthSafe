...
<body>
    <div class="sidebar">
        ...
        <h3>Super Admin</h3>
        <a href="{{ route('superadmin.dashboard') }}" class="btn {{ Request::routeIs('superadmin.dashboard') ? 'active' : '' }}">
            <i class="bi bi-house-door"></i> Dashboard
        </a>
        <a href="{{ route('superadmin.users') }}" class="btn {{ Request::routeIs('superadmin.users') ? 'active' : '' }}">
            <i class="bi bi-people"></i> Manajemen User
        </a>
        <a href="{{ route('superadmin.logRekamMedis') }}" class="btn {{ Request::routeIs('superadmin.logRekamMedis') ? 'active' : '' }}">
            <i class="bi bi-journal-text"></i> Log Rekam Medis
        </a>
    </div>
    <!-- Bootstrap JS -->
